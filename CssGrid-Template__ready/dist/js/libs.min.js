...
/*! jQuery v3.2.1 | (c) Complete_JS_course Foundation and other contributors | jquery.org/license */ !(function (
  e,
  t
) {
      ...
      for (
        ...
        if (null != (e = arguments[s]))
          for (t in e)
            (n = a[t]),
              a !== (r = e[t]) &&
                (l && r && (y.isPlainObject(r) || (i = Array.isArray(r)))
                  ? (i
                      ? ((i = !1), (o = n && Array.isArray(n) ? n : []))
                      : (o = n && y.isPlainObject(n) ? n : {}),
                    (a[t] = y.extend(l, o, r)))
                  : void 0 !== r && (a[t] = r));
      return a;
    }),
  ...
  (y.find = C),
    ...
    (y.uniqueSort = y.unique = C.uniqueSort),
    (y.text = C.getText),
    (y.isXMLDoc = C.isXML),
    (y.contains = C.contains),
    (y.escapeSelector = C.escape);
  ...
  var D = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
    j = /^.[^:#\[\.,]*$/;
  function A(e, t, n) {
    return y.isFunction(t)
      ? y.grep(e, function (e, r) {
    ...
    y.fn.extend({
      find: function (e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            y(e).filter(function () {
              for (t = 0; t < r; t++) if (y.contains(i[t], this)) return !0;
            })
          );
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && S.test(e) ? y(e) : e || [], !1)
          .length;
      },
    });
  var q,
    ...
    if (((n = n || q), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          y.merge(
            this,
            y.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)
          ),
          D.test(i[1]) && y.isPlainObject(t))
        )
          for (i in t)
            y.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
        return this;
      }
      return (
        ...
        for (; r < i; r++)
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              ...
              (a
                ? a.index(n) > -1
                : 1 === n.nodeType && y.find.matchesSelector(n, e))
            ) {
              o.push(n);
              break;
            }
      ...
      function (e, t) {
        y.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (F[e] || y.uniqueSort(i), H.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  function I(e, t, n, r) {
    var i;
    try {
      e && y.isFunction((i = e.promise))
        ? i.call(e).done(t).fail(n)
        : e && y.isFunction((i = e.then))
        ? i.call(e, t, n)
              ...
              (function t(n) {
                y.each(n, function (n, r) {
                  y.isFunction(r)
                    ...
                    : r && r.length && "string" !== y.type(r) && t(r);
                });
              })(arguments),
              n && !t && u()),
            this
    ...
    y.extend({
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return y
                .Deferred(function (e) {
                  n[0][3].add(a(0, e, y.isFunction(i) ? i : R, e.notifyWith)),
                    n[1][3].add(a(0, e, y.isFunction(t) ? t : R)),
                    n[2][3].add(a(0, e, y.isFunction(r) ? r : M));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === a.state() || y.isFunction(i[n] && i[n].then))
        )
          return a.then();
    ...
    y.extend({
      ...
      ready: function (e) {
        (!0 === e ? --y.readyWait : y.isReady) ||
          ((y.isReady = !0),
          (!0 !== e && --y.readyWait > 0) || _.resolveWith(r, [y]));
      },
    }),
    (y.ready.then = _.then),
  ...
  (X.uid = 1),
    (X.prototype = {
      ...
      set: function (e, t, n) {
        var r,
          i = this.cache(e);
        if ("string" == typeof t) i[y.camelCase(t)] = n;
        else for (r in t) i[y.camelCase(r)] = t[r];
        return i;
      },
      get: function (e, t) {
        return void 0 === t
      ...
      remove: function (e, t) {
        ...
        if (void 0 !== r) {
          if (void 0 !== t) {
            Array.isArray(t)
              ? (t = t.map(y.camelCase))
              : (t = (t = y.camelCase(t)) in r ? [t] : t.match(P) || []),
              (n = t.length);
            for (; n--; ) delete r[t[n]];
          }
          (void 0 === t || y.isEmptyObject(r)) &&
          ...
          if (
            ...
            for (n = a.length; n--; )
              a[n] &&
                ...
                ((r = y.camelCase(r.slice(5))), Q(o, r, i[r]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = U.access(e, t, y.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
      dequeue: function (e, t) {
        var n = y.queue(e, (t = t || "fx")),
          r = n.length,
          i = n.shift(),
          o = y._queueHooks(e, t);
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && N(e, t)) ? y.merge([e], n) : n
    );
  }
  function fe(e, t) {
  ...
  function de(e, t, n, r, i) {
        ...
        if ("object" === y.type(o)) y.merge(p, o.nodeType ? [o] : o);
          ...
          for (
            a = a || f.appendChild(t.createElement("div")),
              ...
              u = le[s] || le._default,
              a.innerHTML = u[1] + y.htmlPrefilter(o) + u[2],
              c = u[0];
            c--;
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && y.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = y.contains(o.ownerDocument, o)),
  ...
  (y.event = {
      ...
      if (v)
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            i && y.find.matchesSelector(he, i),
            n.guid || (n.guid = y.guid++),
            (u = v.events) || (u = v.events = {}),
            (a = v.handle) ||
              (a = v.handle = function (t) {
                return void 0 !== y && y.event.triggered !== t.type
          ...
          if (
            ...
            a &&
              ...
              ((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) ||
                y.removeEvent(e, d, v.handle),
              delete u[d]);
          } else for (d in u) y.event.remove(e, d + t[l], n, r, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = y.event.handlers.call(this, s, l), t = 0;
  ...
  function Le(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      m = y.isFunction(v);
    if (m || (p > 1 && "string" == typeof v && !h.checkClone && Ee.test(v)))
    ...
    if (
      ...
      for (u = (s = y.map(ce(i, "script"), De)).length; f < p; f++)
        (l = i),
          f !== d &&
            ((l = y.clone(l, !0, !0)), u && y.merge(s, ce(l, "script"))),
          n.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, y.map(s, je), f = 0; f < u; f++)
          (l = s[f]),
            ue.test(l.type || "") &&
              !U.access(l, "globalEval") &&
              y.contains(c, l) &&
              (l.src
                ? y._evalUrl && y._evalUrl(l.src)
  ...
  function He(e, t, n) {
    for (var r, i = t ? y.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || y.cleanData(ce(r)),
        r.parentNode &&
          (n && y.contains(r.ownerDocument, r) && fe(ce(r, "script")),
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (y.cleanData(ce(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Le(
          ...
          function (t) {
            ...
            y.inArray(this, e) < 0 &&
              (y.cleanData(ce(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  function Ve(e, t, n, r, i) {
    ...
    for (
      ...
      "margin" === n && (a += y.css(e, n + Z[o], !0, i)),
        r
          ? ("content" === n && (a -= y.css(e, "padding" + Z[o], !0, i)),
            "margin" !== n && (a -= y.css(e, "border" + Z[o] + "Width", !0, i)))
          : ((a += y.css(e, "padding" + Z[o], !0, i)),
            "padding" !== n &&
              (a += y.css(e, "border" + Z[o] + "Width", !0, i)));
    return a;
  }
  function Ge(e, t, n) {
    var r,
  ...
  y.extend({
    ...
    y.each(["height", "width"], function (e, t) {
      y.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !Ie.test(y.css(e, "display")) ||
        ...
        set: function (e, n, r) {
          var i,
            ...
            a =
              r &&
              Ve(e, t, r, "border-box" === y.css(e, "boxSizing", !1, o), o);
          return (
            a &&
              (i = K.exec(n)) &&
              "px" !== (i[3] || "px") &&
              ((e.style[t] = n), (n = y.css(e, t))),
            Ue(0, n, a)
          );
        },
      };
    }),
    (y.cssHooks.marginLeft = Me(h.reliableMarginLeft, function (e, t) {
      if (t)
        return (
    ...
    y.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      (y.cssHooks[e + t] = {
        ...
        Fe.test(e) || (y.cssHooks[e + t].set = Ue);
    }),
    y.fn.extend({
      css: function (e, t) {
        return B(
      ...
      _default: {
        ...
        set: function (e) {
          y.fx.step[e.prop]
            ? y.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (null == e.elem.style[y.cssProps[e.prop]] && !y.cssHooks[e.prop])
            ? (e.elem[e.prop] = e.now)
    ...
    prefilters: [
      function (e, t, n) {
        var r,
          ...
          v = U.get(e, "fxshow");
        for (r in (n.queue ||
          (null == (a = y._queueHooks(e, "fx")).unqueued &&
            ((a.unqueued = 0),
            (s = a.empty.fire),
      ...
      return (
        y.fx.off
          ...
          : "number" != typeof r.duration &&
            (r.duration in y.fx.speeds
              ? (r.duration = y.fx.speeds[r.duration])
              : (r.duration = y.fx.speeds._default)),
  ...
  y.fn.extend({
    attr: function (e, t) {
      return B(this, y.attr, e, t, arguments.length > 1);
    },
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && y.isXMLDoc(e)) ||
                (i =
                  ...
                  (y.expr.match.bool.test(t) ? ot : void 0)),
              void 0 !== n
                ? null === n
    ...
    y.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && y.isXMLDoc(e)) ||
              ((t = y.propFix[t] || t), (i = y.propHooks[t])),
            void 0 !== n
              ? i && "set" in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n
          ...
          : this.each(function () {
              var t, r, i, o;
              if ("string" === n)
                for (r = 0, i = y(this), o = e.match(P) || []; (t = o[r++]); )
      ...
      return arguments.length
        ? ((r = y.isFunction(e)),
          this.each(function (n) {
            var i;
            1 === this.nodeType &&
              (null == (i = r ? e.call(this, n, y(this).val()) : e)
                ? (i = "")
                : "number" == typeof i
                ? (i += "")
                : Array.isArray(i) &&
    ...
    y.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = y.makeArray(t), a = i.length;
              a--;

            )
              ((r = i[a]).selected =
                y.inArray(y.valHooks.option.get(r), o) > -1) && (n = !0);
  ...
  y.extend(y.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !pt.test(g + y.event.triggered) &&
          (g.indexOf(".") > -1 &&
            ((v = g.split(".")), (g = v.shift()), v.sort()),
          (c = g.indexOf(":") < 0 && "on" + g),
          ((t = t[y.expando]
            ? t
            : new y.Event(g, "object" == _typeof(t) && t)).isTrigger = o
            ? 2
            : 3),
          (t.namespace = v.join(".")),
  ...
  (At.href = dt.href),
    y.extend({
      ...
      ajax: function (t, n) {
        ...
        var i,
          ...
          h = y.ajaxSetup({}, (n = n || {})),
          g = h.context || h,
          v = h.context && (g.nodeType || g.jquery) ? y(g) : y.event,
          m = y.Deferred(),
        ...
        h.ifModified &&
          (y.lastModified[o] &&
            E.setRequestHeader("If-Modified-Since", y.lastModified[o]),
          y.etag[o] && E.setRequestHeader("If-None-Match", y.etag[o])),
            ...
            l
              ? (h.ifModified &&
                  ((T = E.getResponseHeader("Last-Modified")) &&
                    (y.lastModified[o] = T),
                  (T = E.getResponseHeader("etag")) && (y.etag[o] = T)),
                204 === t || "HEAD" === h.type
                  ? (C = "nocontent")
                  : 304 === t
                  ? (C = "notmodified")
    ...
    y.each(["get", "post"], function (e, t) {
      y[t] = function (e, n, r, i) {
        return (
          y.isFunction(n) && ((i = i || r), (r = n), (n = void 0)),
          y.ajax(
            y.extend(
    ...
    y.fn.extend({
      wrapAll: function (e) {
        ...
        return (
          this[0] &&
            (y.isFunction(e) && (e = e.call(this[0])),
  ...
  y.ajaxSetup({
    ...
    (y.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === l && (e.style.position = "relative"),
          ...
          y.isFunction(t) && (t = t.call(e, n, y.extend({}, s))),
    ...
    y.each(["top", "left"], function (e, t) {
      y.cssHooks[t] = Me(h.pixelPosition, function (e, n) {
        if (n)
          return (n = Re(e, t)), Oe.test(n) ? y(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (y.noConflict = function (t) {
      return e.$ === y && (e.$ = It), t && e.jQuery === y && (e.jQuery = Mt), y;
    }),
    t || (e.jQuery = e.$ = y),
    y
  );
